...
@ApiModel(
  description =
      "The collection of all logical code tables identified during various analysis "
...
public class SystemCodeDTO extends BaseDTO implements Response {
  ...
  @ApiModelProperty(
    value =
        "SYSTEM_ID - The system generated unique number used to identify each permitted "
  ...
  @ApiModelProperty(
    value =
        "CATEGORY_ID - For tables with categories, the 4 digit identifier of the category "
  ...
  @ApiModelProperty(
    value =
        "USER_DEFINED_LOGICAL_ID - A 4 character code which can be used to identify "
  ...
  @ApiModelProperty(
    value =
        "THIRD_ID - This is a system generated unique number that supplements user supplied "
  ...
  @ApiModelProperty(
    value =
        "OTHER_CODE - A 2 character code that can be used to specify additional information "
  ...
  @ApiModelProperty(
    value =
        "INACTIVE_IND - An indicator to specify whether a value in the logical table is "
  ...
  @ApiModelProperty(
    value =
        "SHORT_DESCRIPTION - A mandatory 40 character text field that can be used in screen "
  ...
  @ApiModelProperty(
    value =
        "LONG_DESCRIPTION - A 160 character text field that can appear on screens as "
